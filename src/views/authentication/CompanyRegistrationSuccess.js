  ...
  return (
    <Wrapper>
      ...
      <CommonAuthFlowPage
        ...
        detail={
          "Your initial registration has been successfully completed! A ChooseLife reperentative will contact you to complete your registration and to begin onboarding your organisation."
        }
