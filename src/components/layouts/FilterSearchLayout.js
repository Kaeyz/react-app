		...
		<Wrapper>
			<div>
				<Paper className="top-paper flex flexy">
					...
					<div className="filter"><Filter Icon={filtering} alt='filtering' placeholder="Filter" options={options} width={{ width: 150 }}/></div>
				</Paper>
				<div className={`${display} searchWithButton flex flexy`}>
					<SearchInput Icon={Icon} alt="icon" placeholder="Search Employees..." style={ {width: 300 }}/>
